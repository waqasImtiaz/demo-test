...
import com.airfranceklm.test.dto.ApiErrorDto;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<Object> handleCustomBadRequestException(UserExceptions.BadRequestException
                                                                            badRequestException, WebRequest webRequest) {
    List<String> errors = new ArrayList<>();
    errors.add(badRequestException.getMessage());
    ApiErrorDto apiErrorDto = ApiErrorDto.builder().status(HttpStatus.BAD_REQUEST.toString())
  ...
  public ResponseEntity<Object> handle(Exception ex,
    ...
    if (ex instanceof NullPointerException) {
      apiErrorDto = ApiErrorDto.builder().status(HttpStatus.BAD_REQUEST.toString()).errorNumber(Errors.UNKNOWN_BAD_REQUEST)
    ...
    apiErrorDto = ApiErrorDto.builder().status(HttpStatus.INTERNAL_SERVER_ERROR.toString()).errorNumber(Errors.UNKNOWN_INTERNAL_SERVER_ERROR)
        .messages(errorMessages).timeStamp(LocalDateTime.now().format(dateTimeFormatter)).build();
